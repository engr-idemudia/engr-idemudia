...
**Software Engineer | Full-Stack & Backend · Fintech · Application Security**

Based in Tallinn, Estonia 🇪🇪 · Open to relocation

I build and ship real, deployed applications — across backend, APIs, and full-stack web. I work across backend and full-stack, with a strong interest in security and clean architecture. I hold two BSc degrees, in Software Development & Entrepreneurship and in Mathematics & Computer Science, and I enjoy turning complex problems into reliable, maintainable systems.
...
**DevOps:** Docker · GitHub Actions · CI/CD · Vercel · Render · Netlify · Neon
...
🟢 5 live, deployed projects · actively building and shipping
...
- **[Developer Portfolio](https://github.com/engr-idemudia/my-portfolio)** — Personal portfolio with WebGL and 3D scenes, built on Next.js 16, TypeScript, Tailwind CSS & Framer Motion. [Live →](https://idemudia.dev)
...
Open to full-stack, backend and application security roles. Let's build something solid together.
